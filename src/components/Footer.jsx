...
import fologo from '../assets/logo.png'
        ...
        <div className='flex justify-between'>
          <div className='w-1/3'>
            ...
            <div className='relative pb-6'>
              <input type="emial" placeholder='Enter Email Address' className='w-full h-12 rounded-md pl-5 outline-none' />
          ...
          <div>
            <h4 className='text-[#000000] font-Josefin font-semibold text-[22px] pb-10'>Customer Care</h4>
            <ul className='text-[#8A8FB9] font-Lato'>
              <li className='pb-5'>My Account</li>
